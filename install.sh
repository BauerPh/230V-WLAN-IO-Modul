...
export MAIN_PLATFORMS='declare -A main_platforms=( [esp8266]="esp8266:esp8266:generic:FlashSize=1M192,CpuFrequency=160,CrystalFreq=26,FlashFreq=80,FlashMode=qio,LwIPVariant=v2mss536" )'
